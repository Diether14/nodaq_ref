            ...
            <div class="tab-content">
              ...
              <tbody class="panel">
                  <?php foreach ($community_category as $key => $value): ?>
                    <tr data-toggle="collapse" data-target="#demo<?= $key ?>" data-parent="#myTable">
                    ...
                    <tr  >
                        ...
                        <td class="hiddenRow" style="border:0px;"> </td>
                        <td class="hiddenRow"><div><?= $value->subclass ?></div> </td>
                        <td class="hiddenRow">
                          <button class="btn btn-secondary btn-sm" data-toggle="modal"
                            data-target="#edit_category<?= $key ?>">Update Subclass</button>
                          <button class="btn btn-danger btn-sm" data-toggle="modal"
                            data-target="#delete_category<?= $key ?>">Delete Subclass</button>
                        </td>
