            ...
            <div class="tab-content">
              ...
              <div class="row align-items-center px-3">
                <div class="px-2 col-sm-10 d-flex align-items-center">
                  ...
                  <a class="border border-light btn-transparent btn-sm p-3" data-toggle="modal" data-target="#add_category"><i class="fa fa-plus"></i> Add
                    new</a>
                </div>
                              ...
                              <tbody>
                                <?php foreach ($value['subclass'] as $key1 => $value1) : ?>
                                  <tr>
                                    ...
                                    <td>
                                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit_subclass<?= $key1 ?>"><i class="fa fa-edit"></i></button>
                                      <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_subclass<?= $key1 ?>"><i class="fa fa-trash"></i></button>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form class="contact-form" action="<?= base_url(); ?>/update_subclass" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                            <div class="form-group row">
                                              <div class="col-lg-12">
                                                <label>Subclass Name</label>
                                                <input type="text" name="subclass" class="form-control" value="<?= $value1['subclass'] ?>">
                                  ...
                                  <div class="modal fade" id="delete_subclass<?= $key1 ?>" tabindex="-1" role="dialog">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                          <a href="<?= base_url() ?>/delete_subclass/<?= $value1['id'] ?>/<?= $value1['community_id'] ?>">
