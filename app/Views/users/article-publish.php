  ...
  <div class="col-lg-8">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h4 class="modal-title">Publish Post Title</h4>
          ...
          <div class="form-group">
            <label for="exampleFormControlSelect1">Number of hours</label>
    ...
    <div class="row justify-content-center">
        ...
        <div class="d-flex mt-3">
          ...
          <div class="pl-3">
            <button type="button" class="btn btn-secondary btn-xl">Remove</button>
          </div>
          <div class="pl-3">
            <button type="button" class="btn btn-danger btn-xl">Report</button>
          </div>
          </div>
   ...
   <div class="pl-2 pb-3 text-center">
            <button type="button" class="btn btn-primary btn-xl">Collect</button>
          </div>
      </div>
      </div>
      </div>
