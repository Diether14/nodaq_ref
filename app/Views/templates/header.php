...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-6TN03K0EBL"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());

    gtag('config', 'G-6TN03K0EBL');
  </script>
  <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/css/style.css">
  <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/css/policy.css">
  <title>Nodaq</title>
  ...
  <link href="<?= base_url(); ?>/public/admin/template/fontawesome-free/css/all.min.css" rel="stylesheet"
    type="text/css">
