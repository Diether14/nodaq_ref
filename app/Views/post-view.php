<div class="page-header header-filter" data-parallax="true"
  ...
  <hr>
                            <!-- <a href="#" class="btn btn-link"><i class="fa fa-eye"></i> Share</a> -->
                            <a href="#" class="btn btn-link"><i class="fa fa-comment pr-1"></i>20 Comments <br></a>
                            
                            <?php if(empty($report)): ?>
                            <a href="#"  data-toggle="modal" data-target="#myModal" class="btn btn-link "><i class="fa fa-exclamation pr-1"></i>Report Post</a>
                            <?php else: ?>
                              <a href="#" class="text-danger"><i class=" fa fa-exclamation pr-1"> </i> Reported</a>
                              <?php endif; ?>
