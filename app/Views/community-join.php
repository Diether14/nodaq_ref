...
<div class="main row">
    ...
    <div class="col-lg-2 card card-body m-0">
        <div class="sidebar-item ">
            <div class="row">
                <div class="col-lg-12 text-center community-info-area">
                    <div class="row-item ">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card my-0 rounded-0 ">
                            <div class="text-center bg-primary" id="headingOne">
                                <h2 class="my-0">
                                    <button class="btn btn-link btn-block dropdown-toggle text-left text-white"
                        ...
                        <div class="card my-0 rounded-0">
                            <div class="text-center" id="headingTwo">
                                <h2 class="my-0">
                                    <button class="btn btn-link btn-block dropdown-toggle text-left collapsed"
                ...
                <div class="col-md-12 px-0 of-hidden">
                    ...
                    <div class="row pt-2 bg-white">
                        ...
                        <div class="col-sm-12 mb-0 pt-0 d-flex justify-content-center  text-white pt-3">
                            <ul class="nav nav-pills nav-pills-icons justify-content-center community-tab-opts"
                                role="tablist">
                                ...
                                <table class="table table-hover pt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?= base_url(); ?>/post-view/<?= $value->id ?>"
                                                    class="btn btn-link m-0 p-1">
                                                    <?= $value->title; ?> </a></td>

                                            <td><a href="<?= base_url(); ?>/profile">
                                                    <?= $value->nickname; ?>
                                                </a>
                                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h5 class="create-post-title modal-title w-100 fw600">Create Post</h5>
