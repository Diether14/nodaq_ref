          ...
          <form class="user" action="/weendi/register" method="post">
            ...
            <!-- <div class="form-group row">
              <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="firstname"  placeholder="Firstname..." value="<?= set_value('firstname'); ?>">
                </div>
              ...
              <div class="col-sm-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="lastname"  placeholder="Lastname..." value="<?= set_value('lastname'); ?>">
                </div>
            ...
            <div class="form-group row">
              ...
              <div class="input-group">
                  ...
                  <input type="password" class="form-control  form-control-user" name="password_confirm" id="password_confirm" value="" placeholder="Repeat Password">
                </div>
